...
typedef ClassPtrDef<Datum>::type  DatumPtr;
typedef SharedPtrDef<Datum>::type DatumSharedPtr;
typedef WeakPtrDef<Datum>::type   DatumWeakPtr;
typedef ScopedPtrDef<Datum>::type DatumScopedPtr;
}
