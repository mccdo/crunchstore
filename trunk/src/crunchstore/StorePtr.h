...
typedef ClassPtrDef< Store >::type  StorePtr;
typedef SharedPtrDef< Store >::type StoreSharedPtr;
typedef WeakPtrDef< Store >::type   StoreWeakPtr;
typedef ScopedPtrDef< Store >::type StoreScopedPtr;
}
